...
namespace JamNotes.DAL
{
    ...
    //public class NotesInitializer : DropCreateDatabaseAlways<NotesContext>
    {
        protected override void Seed(NotesContext context)
        {
            ...
            {
                new User {UserName="imatester", Email="test@dummy.com", DateCreated=System.DateTime.Now, Role="User"},
            };
            ...
            var notes = new List<Note> 
            {
                ...
                new Note {UserID=1, BandID=2, SongID=3, ShowDate=DateTime.Parse("1977-05-08"), Description="The most perfect version of this combo", Link=@"https://archive.org/details/gd77-05-08.sbd.hicks.4982.sbeok.shnf"},
                new Note {UserID=1, BandID=2, SongID=4, ShowDate=DateTime.Parse("1997-08-17"), Description="An amazing jazzy journey, one of the best ever", Link=@"https://www.youtube.com/watch?v=kf-nX4G5ny0"},
                new Note {UserID=1, BandID=3, SongID=5, ShowDate=DateTime.Parse("2000-05-05"), Description="Closes out an incredible first set at Jazz Fest on a high note", Link=@"https://archive.org/details/sci2000-05-05.tlm170.flac16"},
                new Note {UserID=1, BandID=3, SongID=6, ShowDate=DateTime.Parse("2001-08-01"), Description="Very adventurious version with a great -> to Lonesome Road Blues", Link="https://archive.org/details/sci2001-08-01-dsbd.shnf"}
            };
